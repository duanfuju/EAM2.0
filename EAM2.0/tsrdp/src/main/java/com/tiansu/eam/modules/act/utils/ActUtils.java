...
//import com.tiansu.eam.modules.sys.entity.EamUser;
...
//	}
	 ...
	 * @return
	 */
/*	public static String getFormUrl(String formKey, ActTask act){
	...
	/*public static UserEntity toActivitiUser(EamUser user){
		if (user == null){
			return null;
		}
...
//		 SystemInfo.out.println(getMobileEntity(user, "@"));
//	}
}
