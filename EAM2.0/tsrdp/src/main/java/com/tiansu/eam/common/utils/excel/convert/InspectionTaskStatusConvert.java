...
/**
 * @creator duanfuju
 * @createtime 2017/10/31 9:51
 * @description:
 * 巡检任务状态
 */
public class InspectionTaskStatusConvert implements IConvertClass {
    ...
    public Map<String, Object> getConvertDataMap() throws Exception {
        ...
        operationworkType_param.put("cond", " dict_type_code = 'inspection_task_status'");
