...
public class EncryptUtil {
    ...
    public static String encrypt64(String xmlStr) {
        byte[] encrypt = null;
        try {
            // 取需要加密内容的utf-8编码。
    ...
    public static String decrypt64(String xmlStr) throws Exception {
        // base64解码
        ...
        return new String(encBuf, "utf-8");
    }
     ...
     * @return 加密后的字符串
     */
    public static String encrypt22(String xmlStr) {
        byte[] encrypt = null;
     ...
     * @throws Exception
     */
    public static String decrypt22(String xmlStr) throws Exception {
        // base64解码
        BASE64Decoder decoder = new BASE64Decoder();
        byte[] encBuf = null;
        try {
