...
public class DevLocFuncPropConvert implements IConvertClass {
	...
	public Map<String, Object> getConvertDataMap()  throws Exception{
		...
		param.put("tabname", "eam_dict");
		param.put("id", "dict_value");
		param.put("name", "dict_name");
		param.put("cond", " dict_type_code = 'function_property'");
