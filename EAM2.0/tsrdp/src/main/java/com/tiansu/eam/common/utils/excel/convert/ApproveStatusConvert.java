 ...
 * @author tiansu
 * @description
 * @create 2017-09-22 9:24
 **/
public class ApproveStatusConvert implements IConvertClass {
    ...
    public Map<String, Object> getConvertDataMap() throws Exception {
        ...
        operationworkType_param.put("cond", " dict_type_code = 'operation_approval_status'");
