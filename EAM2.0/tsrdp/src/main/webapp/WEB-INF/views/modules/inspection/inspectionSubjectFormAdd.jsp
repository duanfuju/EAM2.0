...
<head>
	...
	<script type="text/javascript">
        ...
        $(function () {
            ...
            //设置默认值
            $("#subject_statusBox").val(1).trigger('change.select2');
            ...
            $("#btnSubmit").on("click",function () {
                ...
                if (!form.valid()) {
                    ...
                    if ($("#numberStdTable").children().length <1){
                        $(f_initGrid2);
                        $(f_initGrid1);
                        $("#charStdTable").show().siblings().hide();
                    }
                    //保存数据object
                    var param={};
                    //_devices="9PRCNucZZNutcqfF,JG42PYHss3AqLkec";
					if(_devices.length==0){
                        layer.msg("新增失败,请选择巡检设备！",{time: 1000,icon:2});
                        return;
					}
