    ...
    $(function () {
        try{
            ...
            ligerform = $("#form1").ligerForm({
                ...
                inputWidth : 200,
                fields: [
                    {display: "操作", name: "transfer", newline: true, type: "radiolist",group:"操作信息"},
                    {
                        display: "原因",
                        name: "reason",
                        newline: true,
...
//                        validate: {required: true}
            ...
            var dataGrid = [{ id: 0, name: '接单' },{ id: 1, name: '转单' }];
            $("#transfer").ligerRadioList({
                         data: dataGrid,
                         textField: 'name',
                         value:'0'
                 });
            ...
            $("input:radio[name='transfer']").change(function (){
                var val = liger.get("transfer").getValue();
                if('0' == val){
                    ligerform.setVisible('reason', false);
                }else{
                    ligerform.setVisible('reason', true);
                }
            });
