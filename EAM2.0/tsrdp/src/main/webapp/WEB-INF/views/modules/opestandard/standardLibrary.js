...
define(["text!modules/opestandard/standardLibrary.html", "text!modules/opestandard/standardLibrary.css","liger-all"], function (htmlTemp, cssTemp) {
    ...
    var module = {
       init:function(menuno){
        ...
        initButtonForm : function (id) {
            ...
            /**渲染按钮区域**/
            btnInline =  common.ajaxForButton(id,'json',ctx+"/opestandard/standardLibrary/editUI",ctx + "/opestandard/standardLibrary/delete",ctx+"/opestandard/standardLibrary/detailUI",common.getAreaS(),null,'approve_status',0);
            ...
            $("#add").on("click", function () {
                layer.open({
                    ...
                    closeBtn: 1, //显示关闭按钮
                    content: ctx+"/opestandard/standardLibrary/addUI"
                });
            });
        ...
        initTableForm : function () {
            ...
            for (var i = 0; i < materialTitle.length; i++) {
                if (materialTitle[i].data == "library_status") {
            ...
            var tab = common.renderTable("mytable", {
                ...
                "opBtns": btnInline,
                "ajax": {
                    "url":ctx+ '/opestandard/standardLibrary/listData',
            ...
            $("#edit").on("click", function () {
                ...
                layer.open({
                    ...
                    area: common.getAreaS(), //宽高
                    closeBtn: 1, //显示关闭按钮
                    content: ctx+"/opestandard/standardLibrary/editUI"
                });
            });
            $("#delete").on("click",function () {
                ...
                layer.confirm('确认删掉这条数据吗？',{icon: 3, title:'提示'},function() {
                    ...
                    common.callAjax('post', true, ctx + "/opestandard/standardLibrary/delete", "text", {id: ids}, function (data) {
                        if (data == "success") {
            ...
            $("#fileField").on("change",function () {
                common.setExcel('standardlib');
            });
            //下载模板
            $("#download").on("click",function () {
                common.loadExcelModel("opertionlibrary");
            });
            //导出
            $("#export").on("click",function () {
                ...
                window.open('/exportExcel.do?ids='+(ids.substr(0,ids.length - 1))+'&name=standardlib');
            });
            //全部导出
            $("#exportall").on("click",function () {
                window.open('/exportExcel.do?name=standardlib');
            });
        }
   };
    return module;
