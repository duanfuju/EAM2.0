        ...
        $(function(){
            ...
            common.callAjax('post',false,ctx + "/eam/operationwork/getDeviceInfo","json",{"operationwork_id" : parent.editId},function(data){
                ...
                if(data){
                    ...
                    $("input[name='device_ids']").val(data.deviceIds);
            ...
            common.callAjax('post',false,ctx + "/eam/operationwork/editObj","json",{"id" : parent.editId},function(data){
                ...
                operationwork_statusBox.val(data.operationwork_status);//根据详情渲染下拉框页面显示值
                operationwork_statusBox.trigger('change.select2');
                operationwork_typeBox.val(data.operationwork_type);    //根据详情渲染下拉框页面显示值
                operationwork_typeBox.trigger('change.select2');
            });
            ...
            $("#btnSubmit").on("click",function () {
                ...
                if (!form.valid()) {
                    ...
                    common.callAjax('post',false,'${ctx}/eam/operationwork/update',"json",{param :JSON.stringify(param)},function(data) {
                        if (data.flag) {
...
<body>
<form id="inputForm" action="${ctx}/eam/operationwork/update" method="post" class="form-horizontal">
