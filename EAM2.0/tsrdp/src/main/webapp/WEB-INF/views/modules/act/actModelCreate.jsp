...
<body>
	...
	<form id="inputForm" action="${ctx}/eam/act/model/create" target="_blank" method="post" class="form-horizontal">
		...
		<div class="form-actions">
			...
			<%--<input id="btnCancel" class="btn" type="button" value="关 闭" onclick="layer.closeAll()"/>--%>
		</div>
	</form>
</body>
</html>
