define(["text!modules/eamsys/sysConfig/maintOrderDispConfig.html", "text!modules/eamsys/sysConfig/maintOrderDispConfig.css"], function (htmlTemp, cssTemp) {
    var disp_type;
    var module = {
        init: function () {
        ...
        editBtn:function() {
            ...
            $(".bottom_first").on("click",function(){
                var obj = new Object();
                obj.config_key = 'MAINT_ORDER_DISP_TYPE';
