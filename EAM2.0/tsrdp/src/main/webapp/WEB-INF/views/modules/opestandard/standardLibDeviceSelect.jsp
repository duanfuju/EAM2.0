...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            common.callAjax('post',false,ctx + "/opestandard/standardLibrary/getDeviceTreeData","json",param,function(data){
            ...
            var manager = $("#treeGrid").ligerGrid({
                ...
                data: arrayPush(deviceTreeData), alternatingRow: false, isChecked: getSelect, tree: {columnId: 'id1',idField: 'id',parentIDField: 'parentId'},
                }
            );
            ...
            $("#btnSubmit").on("click",function () {
                ...
                if(deviceIds != null && deviceIds != ""){
                        parent.$("input[name='device_id']").val(deviceName);
                        debugger;
                        parent.$("#deviceId").val(deviceIds);
                        parent.layer.closeAll();
                }else {
                    parent.$("#deviceId").val('');
                    parent.$("input[name='device_id']").val('');
                    parent.layer.closeAll();
                }
