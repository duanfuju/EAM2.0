...
//给编辑页面字段赋值
            common.callAjax('post',false,ctx + "/inspection/inspectionRoute/editObj","json",{"id" : parent.editId},function(data){
                ...
                common.callAjax('post',true,common.interfaceUrl.getDictByDictTypeCode,"json",{"dict_type_code" : "common"},function(data1){
                    ...
                    $("#route_statusBox").html(statusHtml).val(data.route_status).trigger('change.select2').prop("disabled", true);
                });
                common.callAjax('post',true,common.interfaceUrl.getDictByDictTypeCode,"json",{"dict_type_code" : "route_type"},function(data2){
                    ...
                    $("#route_typeBox").html(statusHtml).val(data.route_type).trigger('change.select2').prop("disabled", true);
                });
                common.callAjax('post',true,common.interfaceUrl.getDictByDictTypeCode,"json",{"dict_type_code" : "route_mode"},function(data3){
                    ...
                    $("#route_modeBox").html(statusHtml).val(data.route_type).trigger('change.select2').prop("disabled", true);
                });
                $('#route_isstandardBox').html('<option value="0">否</option><option value="1">是</option>').val(data.route_isstandard).trigger('change.select2').prop("disabled", true);
                //巡检周期
                common.callAjax('post',false,common.interfaceUrl.getDictByDictTypeCode,"json",{"dict_type_code" : "route_period"},function(data4){
                    ...
                    $("#route_periodBox").html(statusHtml).val(data.route_period).trigger('change.select2').prop("disabled", true);
...
//            $("select").attr("disabled","disabled");
            // 将时间设置为只读
            $(".hasDatepicker").attr("disabled","disabled");

            $(".choose").attr("disabled","disabled");

//            $("#s2id_autogen16").attr("disabled","false");
