	...
	<script type="text/javascript">
        $(function () {
            ...
            var data2 = {
                Rows: [
                    {
                        "maintain_standard_code":'BYBZ001',
           ...
           // $(f_initGrid3);
            ...
            var data4 = {
                Rows: [
                    {
                        "failure_phenomena_code":'GZXX001',
                        "failure_phenomena_priority":0,
                        "failure_phenomena_desc":null,
                        "failure_cause_code":'GZYY001',
						"failure_cause_serverity":0,
						"failure_cause_desc":null,
						"failure_measures_code":'GZCS001',
            ...
            var data5 = {
                Rows: [
                    {
                        "operation_standard_code":'YXBZ001',
...
//获取编码
            common.ajaxForCode({type:"STAND_LIBRARY"},false,"text",function(data){
                if (data !="" ||data !=null) {
					$("input[name='library_code']").val(data);
                }
            })
            ...
            common.callAjax('post',false,common.interfaceUrl.getDictByDictTypeCode,"json",{"dict_type_code" : "common"},function(data){
                ...
                var library_statusBox= $("#library_statusBox");
                library_statusBox .html(statusHtml);
                library_statusBox.val(1);//设置默认值
...
//复杂表单用ajax提交
				...
				console.log(param);
                common.callAjax('post',false,'${ctx}/opestandard/standardLibrary/insert',"text",{param:JSON.stringify(param)},function(data){
                    if(data=="success"){
...
<body>
<form id="inputForm" action="${ctx}/opestandard/standardLibrary/insert" method="post" class="form-horizontal">
