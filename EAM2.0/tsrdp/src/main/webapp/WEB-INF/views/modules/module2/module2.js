define(["text!modules/module2/module2.html", "text!modules/module2/module2.css"], function (htmlTemp, cssTemp) {
    var module = {
       init:function(){
           ...
           $(".guide").on("click", function () {
               ...
               setTimeout(function () {
                   ...
                   steplist.newGuidStep("#posA", "这是标题2啊", "请输入查询条件");
                   steplist.startGuide();
               },300);

           })
           //if (localStorage.getItem($(".span_word").text()) !=1 ) {
           var steplist = $.WebPageGuide({showCloseButton: true});
           steplist.newGuidStep(".queryBtn", "这是标题1啊", "点击显示查询区域");
           steplist.newGuidStep("#posA", "这是标题2啊", "请输入查询条件");
           steplist.startGuide();
           //localStorage.setItem($(".span_word").text(), 1);
           //}
