...
KISBPM.TOOLBAR = {
    ACTIONS: {
        ...
        closeEditor: function(services) {
            ...
            //edit begin by q1210,2017-08-02
            //edit不开新页面，在系统内打开，关闭时返回上一页
            if(window.confirm('请确认数据是否已经保存，确定要关闭编辑器吗0811？')) {
                debugger;
            ...
            // if (window.confirm('请确认数据是否已经保存，确定要返回？')) {
            //     window.history.back();
            // }
            //edit end
    ...
    function ($rootScope, $scope, $http, $route, $location) {
        ...
        $scope.saveAndClose = function () {
            $scope.save(function() {
                ...
                //edit begin by q1210,2017-08-02
                //edit不开新页面，在系统内打开，关闭时返回上一页
                /*if (layer.confirm('数据已经保存，确定要关闭编辑器0811？')) {
                    //window.close();//add by cheshuyan at 2016.05.21
